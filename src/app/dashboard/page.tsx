                    ...
                    <div className="w-full bg-white/10 rounded-lg p-2">
                        <div className="flex lg:flex-row flex-col">
                            <div className="flex-1 relative overflow-hidden">
                                ...
                                />
                                <div className="bg-white/10 backdrop-blur-sm rounded-b-lg w-full h-16 absolute bottom-0 left-0 z-20 flex justify-between items-center p-2">
                                    <div className="">
                                        <p className="text-white/60 text-xs">Current Price</p>
                                        <p className="text-white font-bold text-xl">$99.99</p>
                                    </div>

                                    <button className="bg-white/10 px-6 py-2 rounded-lg font-medium">Buy Now</button>
                                </div>
                            </div>
                            <div className="flex-1 p-2 relative">
                                <p className="font-bold text-4xl">Telegram Nitro Mini App</p>
                                <p className="text-white/50 my-4">a new telegram mini app source code with new ui and huge updated function, improve security and awesome user experiance and lot of new thing.</p>
                                <div className="lg:absolute bottom-2 left-2 w-full flex items-center gap-3">
                                    ...
                                    <div className="">
                                        <p>Siam Sheikh</p>
                                        <p className="capitalize text-white/60 text-xs">publisher</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="bg-white/10 rounded-lg p-3 w-full">
                            ...
                            <div className="bg-white/10 p-2 rounded-lg">
                                <div className="flex justify-between items-center">
                                    <p className="text-white/50 text-xs">Total Sold</p>
                                    <p className="bg-white/10 w-fit px-2 rounded-full text-xs">+90%</p>
                                </div>
                                <p className="text-4xl font-medium mt-5">$4869,0</p>
                            </div>
                        </div>

                        <div className="bg-white/10 rounded-lg mt-5 p-2">
                            <p className="font-bold">History</p>

                            <div className="flex items-center gap-3 justify-between mt-3 bg-white/10 p-2 rounded-lg">
                                <div className="flex items-center gap-2">
                                    <div className="size-10 rounded-full bg-white/10"></div>
                                    <div className="">
                                        <p className="line-clamp-1 font-bold">Telegram Ultra</p>
                                        <p className="line-clamp-1 text-xs text-white/50 font-medium">Pub: Siam Sheikh</p>
                                    </div>
                                </div>
