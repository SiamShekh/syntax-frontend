...
function Blog() {
    return (
        <div className="relative bg-black/10 dark:bg-white/10 rounded-xl overflow-hidden">
        ...
        <div className="p-3">
            ...
            <p className="font-medium text-xs line-clamp-4 my-3 text-black/40 dark:text-white/40">Lorem ipsum dolor sit amet consectetur adipisicing elit. Totam laboriosam voluptates fugit labore, numquam recusandae in aliquid expedita saepe est, quis omnis nihil rem quod asperiores dolores nesciunt libero perferendis.</p>
